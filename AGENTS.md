# AI Agent Instructions: FFC-EX-SRRN.net
...
These sites deploy to `https://freeforcharity.github.io/FFC-EX-SRRN.net/` and optionally to a custom domain if one is configured for this repo.
